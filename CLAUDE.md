...
1. Cover — "The AI creative platform for studio-quality product images and video." Logo + headline centred; the bottom of the slide holds two stacked badge rows (positioning tags "Applied AI Research Lab" / "Visual Commerce", then partners Amazon / NVIDIA / Google / Startup India Program). The old "Powered by" label was removed and the two positioning tags moved down from under the headline. The `.pwr` CSS class is now unused.
